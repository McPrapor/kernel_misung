...
//	kal_int16 dummy_line;
	...
	LOG_INF("framerate = %d, min_framelength_en %d. min framelength should enable? \n", framerate,min_framelength_en);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	printk("[camdebug] s5k5e8 get_imgsensor_id called\n");
	...
	printk("[camdebug] s5k5e8 get_imgsensor_id 0x%x must be 0x%x \n", *sensor_id , imgsensor_info.sensor_id);
	if (*sensor_id != imgsensor_info.sensor_id) {
		// if Sensor ID is not correct, Must set *sensor_id to 0xFFFFFFFF 
		*sensor_id = 0xFFFFFFFF;
	printk("[camdebug] s5k5e8 get_imgsensor_id return 0xFFFFFFFF\n");
...
static kal_uint32 open(void)
{
	...
	LOG_1;
	LOG_2;
	printk("[camdebug] s5k5e8yxv36 open debug\n");
	if(first_flag != 0){
		LOG_INF("modify device I2C address to 0x5a\n");
		printk("[camdebug] modify device I2C address to 0x5a\n");
...
UINT32 S5K5E8YXV36_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    ...
    printk("[camdebug] S5K5E8YXV36_MIPI_RAW_SensorInit called\n");
    if (pfFunc!=NULL) {
        *pfFunc=&sensor_func;
            printk("[camdebug] S5K5E8YXV36_MIPI_RAW_SensorInit pfFunc != NULL\n");
        } else {
            printk("[camdebug] S5K5E8YXV36_MIPI_RAW_SensorInit pfFunc == NULL\n");
