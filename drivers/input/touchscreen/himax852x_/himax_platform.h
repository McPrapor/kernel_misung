...
struct himax_i2c_platform_data {	
	...
	bool probe_check_flag; //probe loadconfig flag
	bool switch_invert; // for i2c switch pin between MCU and sensorhub use or not 
...
extern void himax_switch_gpio_set(int pinnum, uint8_t value);
