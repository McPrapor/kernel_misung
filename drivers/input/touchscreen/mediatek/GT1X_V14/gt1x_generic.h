...
#endif
#ifndef __HCT_GTP_HOTKNOT__
#define __HCT_GTP_HOTKNOT__			0
#endif
...
#define GTP_PROXIMITY_SPECIAL         1	// proximity special module (function as the p-sensor)
#endif
#else 
#define GTP_PROXIMITY_SPECIAL         0	// proximity special module (function as the p-sensor)
#endif
...
#if defined(__HCT_GT1X_ESD_PROTECT_SUPPORT__)
#if __HCT_GT1X_ESD_PROTECT_SUPPORT__
...
#if defined(__HCT_GTP_DRIVER_SEND_CFG__)
    #ifdef __HCT_CTP_CFG_GROUP2__
        #define GTP_CFG_GROUP2  __HCT_CTP_CFG_GROUP2__
    #else
